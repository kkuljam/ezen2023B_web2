...
const doPOst= () =>{
    ...
    <button type="button" onClick={함수명2}>함수명1 실행</button>
    <button type="button" onClick={함수명3}>함수명1 실행</button>
    <button type="button" onClick={doGet}>axios/doGet</button>
    <form id="axiosForm"> <input type="text" /> </form>
    <button type="button" onClick={doPOst}>axios/doPOst</button>
    <button type="button" onClick={doPut}>axios/doPut</button>
    <button type="button" onClick={doDelete}>axios/doDelete</button>
    </>)
}